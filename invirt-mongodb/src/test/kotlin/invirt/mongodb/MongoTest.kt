...
class MongoTest : StringSpec() {
    ...
    init {
        "databaseName" {
            ...
            Mongo("mongodb+srv://user:password@server.host.name.net/database1?retryWrites=true&w=majority").databaseName shouldBe "database1"
            Mongo("mongodb+srv://server.host.name.net/database2?retryWrites=true&w=majority").databaseName shouldBe "database2"
